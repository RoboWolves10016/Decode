...
import static org.firstinspires.ftc.teamcode.opmodes.auton.CloseAutonPaths.*;
...
@Autonomous(name="Close 9")
public class Close6 extends OpMode {
...
//                    follower.followPath(row1To);
            ...
            case 6:
                ...
                if (!follower.isBusy() || stateTimer.seconds() > 3) {
                    ...
                    intake.setWantedState(Intake.IntakeWantedState.IDLE);
                    indexer.setWantedState(Indexer.IndexerWantedState.IDLE);
//                    follower.followPath(corner2ToLaunch);
                    advanceAutonState();
                }
                break;
            case 7:
