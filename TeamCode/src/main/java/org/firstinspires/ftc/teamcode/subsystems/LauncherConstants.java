...
public class LauncherConstants {
    // Flywheel Constants
    public static final double[] SHOT_DISTANCES = {24, 32, 40, 52, 64, 75, 85, 95, 110, 130, 140};
    public static final double[] SHOT_SPEEDS = {2600, 2600, 2700, 2800, 3000, 3050, 3200, 3350, 3500, 3850, 3950};
...
//    public static final double[] SHOT_ANGLES = {22, 25, 26, 30, 32, 35, 37, 39, 43, 45, 47};
    public static final double[] SHOT_ANGLES = {22, 25, 26, 30, 32, 38, 39.5, 41, 43, 45, 47};
